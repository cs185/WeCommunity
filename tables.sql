...
CREATE TABLE `user` (
  ...
  `type` int DEFAULT NULL COMMENT '0-regular user; 1-premium; 2-super premium;',
  `status` int DEFAULT NULL COMMENT '0-inactive; 1-active;',
  `activation_code` varchar(100) DEFAULT NULL,
  `header_url` varchar(200) DEFAULT NULL,
  `create_time` timestamp DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `index_username` (`username` (20)),
  UNIQUE KEY `index_email` (`email`(20))
);
...
VALUES
(11, 'group 1', 10, '2024-06-01 08:00:00'),
(12, 'group 2', 15, '2024-06-02 09:30:00'),
(13, 'group 3', 5, '2024-06-03 10:45:00'),
(21, 'group 4', 20, '2024-06-04 12:00:00'),
(25, 'group 5', 25, '2024-06-05 14:30:00');

CREATE TABLE `user_group` (
  `user_id` int NOT NULL,
  `group_id` int NOT NULL,
  `type` int DEFAULT NULL COMMENT '0 - reguar; 1 - admin; 2 - owner',
